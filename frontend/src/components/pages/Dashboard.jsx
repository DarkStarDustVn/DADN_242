      ...
      <div className="w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white flex flex-col shadow-xl">
        ...
        <div className="p-5 border-b border-gray-800">
          <div className="flex items-center space-x-3">
            <div className="relative w-10 h-10">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-lg shadow-lg transform -rotate-6 opacity-75"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-lg shadow-lg"></div>
              <svg className="relative w-full h-full p-1 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
              </svg>
            </div>
            <div className="flex flex-col justify-center">
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">Smart Home</h1>
              <div className="text-xs text-blue-300">Lối sống hiện đại 4.0</div>
            </div>
          </div>
        </div>
          ...
          <ul className="py-4">
            ...
            <li className="mb-1">
              ...
              >
                ...
                <span className="text-base">Quản lý thiết bị</span>
              </Link>
            </li>
            <li className="mb-1">
              <Link 
              ...
              >
                ...
                <span className="text-base">Dữ liệu sử dụng</span>
              </Link>
            </li>
            <li className="mb-1">
              <Link 
        ...
        <div className="p-4 border-t border-gray-800">
          <button 
            ...
            className="w-full flex items-center px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded transition-colors duration-200"
          >
            <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
