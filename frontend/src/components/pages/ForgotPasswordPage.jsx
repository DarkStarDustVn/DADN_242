...
const ForgotPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/auth/forgot-password`, {
        method: 'POST',
      ...
      <div className="w-full md:w-1/4 flex items-center justify-center bg-gray-900 text-white p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400">Nhập email của bạn và chúng tôi sẽ gửi bạn đường dẫn để bạn đặt lại mật khẩu.</p>
          </div>
